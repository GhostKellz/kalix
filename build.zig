...
pub fn build(b: *std.Build) void {
    ...
    const zvm_dep = b.dependency("zvm", .{
        .target = target,
        .optimize = optimize,
    });
    const zvm_mod = zvm_dep.module("zvm");
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "kalix" is the name you will use in your source code to
                // import this module (e.g. `@import("kalix")`). The name is
